/*
*  Credit to: https://stackoverflow.com/questions/11383070/pretty-print-2d-array-in-java
*/
...
public final class PrettyPrinter {
    ...
    public void print(int[][] table) {
    	String[][] converted = Arrays.stream(table).map(a -> Arrays.stream(a).mapToObj(i -> Integer.toString(i)).toArray(String[]::new)).toArray(String[][]::new);
